        ...
        <Container maxWidth="lg" style={{ marginBottom: '15px' }}>
          ...
          <Paper elevation={6} sx={{ p: 4, margin: 'auto', maxWidth: 936 }}>
            ...
            <Box display="flex" justifyContent="center" margin={2} onClick={handleClickOpenOverview}>
              <img src={`${process.env.PUBLIC_URL}/assets/My-App-Overview.drawio.svg`} alt={t('aboutThisWebsite.technologiesAndToolsUsed.overviewImageAlt')}
            ...
            <Box display="flex" justifyContent="center" margin={2} onClick={handleClickOpenDetail}>
              <img src={`${process.env.PUBLIC_URL}/assets/My-App-diagrams.drawio.svg`} alt={t('aboutThisWebsite.technologiesAndToolsUsed.awsDetailImageAlt')}
                style={{ width: '60%', height: 'auto' }} />
            </Box>
            <BootstrapDialog
